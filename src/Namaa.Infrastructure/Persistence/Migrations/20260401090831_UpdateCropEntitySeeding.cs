...
{
    /// <inheritdoc />
    public partial class UpdateCropEntitySeeding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "Id",
                keyValue: 83,
                columns: new[] { "MaxExpectedPrice", "SupportedEnvironmentTypes", "SupportedIrrigationMethods" },
                values: new object[] { 9.0m, new List<string> { "Greenhouse", "Open Field" }, new List<string> { "Drip" } });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 83,
                columns: new[] { "MaxExpectedPrice", "SupportedEnvironmentTypes", "SupportedIrrigationMethods" },
                values: new object[] { 12.0m, new List<string> { "Greenhouse", "Open Field" }, new List<string> { "Drip" } });
