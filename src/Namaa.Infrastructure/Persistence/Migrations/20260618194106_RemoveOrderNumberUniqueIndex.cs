...
{
    /// <inheritdoc />
    public partial class RemoveOrderNumberUniqueIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"DROP INDEX IF EXISTS ""IX_ProductOrders_OrderNumber"";");
           migrationBuilder.Sql(@"ALTER TABLE ""ProductOrders"" DROP CONSTRAINT IF EXISTS ""IX_ProductOrders_OrderNumber"";");
