...
public class UpdateInvestmentProjectCommandHandler(
    IAppDbContext context,
    IUserReadRepository userReadRepository)
    : IRequestHandler<UpdateInvestmentProjectCommand, Result<InvestmentProjectDto>>
{
    public async Task<Result<InvestmentProjectDto>> Handle(
        UpdateInvestmentProjectCommand request,
