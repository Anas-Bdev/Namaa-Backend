...
public static class ApplicationErrors
{
    ...
    public static readonly Error AlreadyExists = Error.Conflict("Profile.AlreadyExists", "A profile of this type already exists for the current user.");
    public static readonly Error FarmerNotFound = Error.NotFound("Farmer.NotFound", "The farmer profile you are looking for was not found.");
    public static readonly Error TraderNotFound = Error.NotFound("Trader.NotFound", "The Trader profile you are looking for was not found.");
    public static readonly Error InvestorNotFound = Error.NotFound("Investor.NotFound", "The Investor profile you are looking for was not found.");


    // Marketplace
    public static readonly Error ListingNotFound = Error.NotFound("Listing.NotFound", "Product listing not found.");
    public static readonly Error ListingHasActiveOrders = Error.Conflict("Listing.HasActiveOrders", "Cannot delete a listing with active orders.");
    public static readonly Error OrderNotFound = Error.NotFound("Order.NotFound", "Order not found.");
    public static readonly Error OrderNotPaid = Error.Conflict("Order.NotPaid", "Order must be paid before rating.");
    public static readonly Error SeedingCycleNotCompleted = Error.Conflict("SeedingCycle.NotCompleted", "Seeding cycle must be completed before adding a listing.");
}
